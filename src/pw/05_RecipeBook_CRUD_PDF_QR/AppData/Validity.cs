...
namespace RecipeBook.AppData
{
    internal class Validity
    {
        ...
        /// <summary>
        /// Patter to match URLs starting with http:// or https://
        /// </summary>
        /// <example>
        /// Matches foo-bar.baz@example.com
        /// </example>
        private static string urlPattern = "^(https?://)?([a-zA-Z0-9]([a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?\\.)+[a-zA-Z]{2,6}(/.*)?$";
        ...
        public static bool checkUrl(string val) => Regex.IsMatch(val, urlPattern);
